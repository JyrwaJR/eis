...
//
// export function SalaryStatemen() {
...
//                   <Text className="text-4xl font-extrabold tracking-tight text-black">
...
//                 {/* Earnings Section */}
//                 <View className="overflow-hidden rounded-md border border-gray-200 bg-white shadow-sm dark:border-neutral-700 dark:bg-neutral-800">
//                   <View className="flex-row items-center border-b border-gray-200 bg-gray-50 p-4 dark:border-neutral-700 dark:bg-neutral-700/50">
...
//   return (
//     <View
//       className={`min-h-[44px] flex-row items-center justify-between bg-white px-4 py-3 dark:bg-neutral-800 ${
//         !isLast ? 'border-b border-gray-100 dark:border-neutral-700/50' : ''
//       }`}>
//       <Text className="text-base text-graphite dark:text-gray-400">{label}</Text>
//       <Text className="text-base font-medium text-gray-900 dark:text-white">{amount}</Text>
//     </View>
//   );
// }
